...
Source0  : https://www.riverbankcomputing.com/static/Downloads/QScintilla/2.13.4/QScintilla_src-2.13.4.tar.gz
...
%prep
%setup -q -n QScintilla_src-2.13.4
cd %{_builddir}/QScintilla_src-2.13.4
...
%install
export SOURCE_DATE_EPOCH=1675988309
rm -rf %{buildroot}
